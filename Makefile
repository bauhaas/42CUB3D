...
#    Updated: 2021/02/14 22:32:56 by bahaas           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME	= cub3D
SRCS	= srcs/render.c srcs/cast_hz.c srcs/cast_vt.c srcs/cast_ray.c srcs/minimap.c srcs/utils.c srcs/key_events.c srcs/parsing.c \
		  ...
		  srcs/sprites.c srcs/utils_sprites.c srcs/utils_render.c srcs/render_sprites.c
#SRCS	= srcs/parsing.c \
		  srcs/player.c srcs/texture.c srcs/grid.c srcs/utils_parsing.c srcs/grid_parsing.c srcs/colors.c srcs/resolution.c \
